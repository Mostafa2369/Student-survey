<%-- 
    Document   : freeansup
    Created on : Dec 16, 2017, 10:38:55 PM
    Author     : Mostafa
--%>
    ...
    <body>
        <%   String name = request.getParameter("suspend");
            ...
            while (rs.next()) {
                ...
                String c = "UPDATE freeans SET `suspend` = 1,`close` = 0 WHERE `ques` = '"+name4+"'";
            ...
            while (rs.next()) {
                ...
                String c = "UPDATE freeans SET `close` = 1,`suspend` = 0 WHERE `ques` = '"+name5+"'";
                stmt.executeUpdate(c);
                out.print(name5);
            }
